...
public class PostBridgePackagerAABitmap extends ISOBasePackager {
    ...
    protected static class PostPrivatePackager extends ISOBasePackager {
        protected ISOFieldPackager[] fld127 = new ISOFieldPackager[]{new IF_CHAR(0, "PLACEHOLDER"),

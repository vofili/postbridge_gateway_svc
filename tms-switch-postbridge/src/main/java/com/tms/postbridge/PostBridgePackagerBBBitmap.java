...
public class PostBridgePackagerBBBitmap extends ISOBasePackager {
    ...
    protected static class PostPrivatePackager extends ISOBasePackager {
        protected ISOFieldPackager[] fld127 = new ISOFieldPackager[]{
                ...
                new IF_CHAR(1, "CARD VERIFICATION RESULT"),
                new IFA_NUMERIC(4, "AMERICAN EXPRESS CARD IDENTIFIER"),
                new IFB_BINARY(40, "3D SECURE DATA"),
                new IF_CHAR(1, "3D SECURE RESULT"),
                new IFA_LLCHAR(11, "ISSUER NETWORK ID"),
                new IFB_LLBINARY(33, "UCAF DATA"),
                new IFA_NUMERIC(4, "EXTENDED TRANSACTION TYPE"),
                new IFA_NUMERIC(2, "ACCOUNT TYPE QUALIFIERS"),
                new IFA_LLCHAR(11, "ACQUIRER NETWORK ID"),
                new IFA_LLCHAR(25, "CUSTOMER ID"),
                new IF_CHAR(4, "EXTENDED RESPONSE CODE"),
                new IFA_LLCHAR(99, "ADDITIONAL POS DATA CODE"),
                new IF_CHAR(2, "ORIGINAL RESPONSE CODE"),
                new IFA_LLCHAR(99, "REMOTE ADDRESS"),
                new IFA_LLCHAR(99, "LOCAL ADDRESS")
        };

        protected PostPrivatePackager() {
            this.setFieldPackager(this.fld127);
        }
    }
}
